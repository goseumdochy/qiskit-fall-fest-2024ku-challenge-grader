...
setup(
    name='qff_2024ku_grader',
    version=get_version('qff_2024ku_grader/__init__.py'),
    description='Grading qiskit fall fest at Korea University 2024',
    url='https://github.com/goseumdochy/qiskit-fall-fest-2024ku-challenge-grader',
